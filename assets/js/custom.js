...
======================================*/
	...
	//filtration
	$('.charity-op-menu .title').on('click', function(){
	...
	---------------------------------*/
	$(window).on('load', function(){
		if($('.charity-op-container').length){
			var $container = $('.charity-op-container').isotope({
			    itemSelector: '.charity-op-item',
			    masonry: {
			        columnWidth: '.charity-op-sizer'
			    }
			});

			$('.charity-op-menu button').on('click', function() {
		        if($(this).hasClass('active')) return false;
		        $(this).parent().find('.active').removeClass('active');
		        $(this).addClass('active');
		        $(this).closest('.charity-op-menu').find('.title').text($(this).find('.text').text());
		        if($(this).closest('.charity-op-menu').find('.title').is(':visible')) $(this).closest('.charity-op-menu').find('.toggle').slideUp();
